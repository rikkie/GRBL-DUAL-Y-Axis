...
#if N_AXIS > 4
  #define AXIS_5 4
  #define AXIS_5_NAME 'Y' // Letter of axis number 5  RIKKIE
#endif
#if N_AXIS > 5
  #define AXIS_6 5
...
// define to force Grbl to always set the machine origin at the homed location despite switch orientation.
 #define HOMING_FORCE_SET_ORIGIN // Uncomment to enable. RIKKIE
...
// tool length offset value is subtracted from the current location.
  #define TOOL_LENGTH_OFFSET_AXIS AXIS_3 // Default z-axis. Valid values are AXIS_1, AXIS_2, or AXIS_3. RIKKIE
